...
def toJSON(start_date, end_date, variable):
    """
    This function receives a time frame and produces a json version of the data
    stored at the netcdf repository.
    """
    ...
    for file_name in data_files:
        file_date = \
            datetime.datetime.strptime(file_name.split('.')[2],"%Y%m%d").date()
...
def main():
    print(toJSON("20151015", "20151115", "temp_mean"))
